...
const createProductSlug = (product, language = 'en') => {
...
function App() {
  ...
  return (
    <>
      {/* ================= SMALL PWA INSTALL BUTTON ================= */}

      {installPrompt &&
        !isAppInstalled() && (
          <button
            className="pwa-small-install-button"
            onClick={installApp}
            aria-label="Install Uma Z&S Beauty"
          >
            📱
            <span>Install</span>
          </button>
